...
known issues so keep your eye on [this project board](https://github.com/AlpineAIO/wails/projects/7) and if you would
...
Your input would be most welcome! Please direct any feedback to the [v2 Beta](https://github.com/AlpineAIO/wails/discussions/828)
discussion board.

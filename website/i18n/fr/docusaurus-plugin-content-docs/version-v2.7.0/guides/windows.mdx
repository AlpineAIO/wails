...
Solution provided by [sithembiso](https://github.com/sithembiso) on the [discussions board](https://github.com/AlpineAIO/wails/discussions/1734#discussioncomment-3386172).

...
func GetReleaseNotes(tagVersion string, noColour bool) string {
	resp, err := http.Get("https://api.github.com/repos/AlpineAIO/wails/releases/tags/" + url.PathEscape(tagVersion))
	if err != nil {
...
func GetVersionTags() ([]*SemanticVersion, error) {
	...
	resp, err := http.Get("https://api.github.com/repos/AlpineAIO/wails/tags")
	if err != nil {
		return result, err
	}
	body, err := io.ReadAll(resp.Body)
